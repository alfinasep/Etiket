        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>transaksi list
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Tambah transaksi</a>
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="transaksi-table" class="table table-stripped">
                        <thead>
                            <tr>
                                <th> No </th>
                                <th> Hari </th>
    ...
    <script type="text/javascript">
      var table = $('#transaksi-table').DataTable({
                      ...
                      columns: [
                        ...
                        {data: 'tra', name: 'film'},
                        {data: 'trans', name: 'seat'},
                        {data: 'jumlah_tiket', name: 'jumlah_tiket'},
                        {data: 'jumlah_harga', name: 'jumlah_harga'},
                        {data: 'ticket_auth', name: 'ticket_auth'},
                        {data: 'ticket_pass', name: 'ticket_pass'},
                        {data: 'action', name: 'action', orderable: false, searchable: false}
                      ]
                    });

        $('#jumlah_tiket').on('focusout',function(){
        $('#jumlah_harga').val('');
        $('#jumlah_harga').val($(this).val()*30000);
      ...
      function addForm() {
        ...
        $('.modal-title').text('Add transaksi');
      }
      ...
      //       $('#kursi_id').val(data.kursi_id);
      //       $('#jumlah_tiket').val(data.jumlah_tiket);
      //       $('#jumlah_harga').val(data.jumlah_harga);
      //       $('#ticket_auth').val(data.ticket_auth);
      //       $('#ticket_pass').val(data.ticket_pass);
      //     },
      //     error : function() {
      //         alert("Nothing Data");
      //     }
